...
const Sidebar = ({ showSidebar }) => {
  return (
    <div
      className={`lg:w-auto lg:relative lg:translate-x-0 lg:col-span-1 lg:text-white lg:bg-none w-64 absolute inset-y-0 left-0 transform transition duration-200 ease-in-out flex flex-col bg-fixed bg-contain bg-drawer text-black  text-sm font-light p-4 space-y-6 ${
        showSidebar
